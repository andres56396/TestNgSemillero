...
public static void stratRecording(String methoName,File ratCarpeta) throws IOException, AWTException 
{
    
	System.out.println("Inicia proceso de gradacion");
...
public static void stopRecording() throws IOException 
{
	...
	System.out.println("Finalizo proceso de grabacion");
